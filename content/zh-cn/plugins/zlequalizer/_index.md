...
- 良好的音质：64 位浮点运算与 De-Cramping 技术结合，使得低频与高频的表现都一样出色
...
当[动态](#动态与阈值学习)功能打开后，您可以通过鼠标左键拖拽/单击、滑动鼠标滚轮调整基准滤波器的增益；通过鼠标右键（或 Ctrl/Command + 鼠标左键）拖拽/单击、Ctrl/Command + 滑动鼠标滚轮调整目标滤波器的增益。

___

**带宽（Q）**

当[动态](#动态与阈值学习)功能打开后，您可以通过鼠标左键拖拽/单击、滑动鼠标滚轮调整基准滤波器的Q值；通过鼠标右键（或 Ctrl/Command + 鼠标左键）拖拽/单击、Ctrl/Command + 滑动鼠标滚轮调整目标滤波器的Q值。
