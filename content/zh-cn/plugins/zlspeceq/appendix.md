...
感谢 Yuriy Ivantsov, Martin Vicanek 和 Nigel Redmon 分享滤波器参数计算方法和滤波器级联方法。
...
如果您有一般性的建议或疑问，可以在[讨论区](https://github.com/ZL-Audio/ZLSpectrumEqualizer/discussions)提出。

如果您有针对性的错误报告或功能要求，可以在[问题区](https://github.com/ZL-Audio/ZLSpectrumEqualizer/issues)提出。
